...
def classification_metric(y_true, y_pred, average='macro', verbose=True, decimals=4):
    ...
    return {'accuracy': accuracy, 'precision': precision, 'recall': recall, 'f_measure': f_score, 'PUR': pur}, confusion_matrix
